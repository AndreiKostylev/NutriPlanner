...
namespace NutriPlanner.Migrations
{
    ...
    [Migration("20251224134420_AddPlanProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NutriPlanner.Models.PlanProduct", b =>
                {
                    b.Property<int>("PlanProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlanProductId"));
            ...
            modelBuilder.Entity("NutriPlanner.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 12, 24, 18, 44, 19, 428, DateTimeKind.Local).AddTicks(6076),
                            RoleId = 3,
                            Username = "admin",
                            Weight = 75m
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "hashed_password",
                            RegistrationDate = new DateTime(2025, 12, 24, 18, 44, 19, 428, DateTimeKind.Local).AddTicks(6080),
                            RoleId = 2,
                            Username = "dietitian",
                            Weight = 60m
                        });
            ...
            modelBuilder.Entity("NutriPlanner.Models.PlanProduct", b =>
                {
                    b.HasOne("NutriPlanner.Models.NutritionPlan", "NutritionPlan")
